...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 02 Ara 2020, 16:36:18
...
CREATE TABLE `submissions` (
  ...
  `prevSubmissionID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `submissions` (`AuthenticationID`, `ConfID`, `SubmissionID`, `prevSubmissionID`) VALUES
(11111, 'id124', 1, NULL),
(11111, 'id124', 2, 1),
(11111, 'id124', 3, 2);
...
INSERT INTO `userlog` (`AuthenticationID`, `Title`, `Name`, `LastName`, `Affiliation`, `primary_email`, `secondary_email`, `password`, `phone`, `fax`, `URL`, `Address`, `City`, `Country`, `Record`, `Creation`, `Date`) VALUES
(11111, 'Ms', 'Beyza', 'Genc', 'Pro', 'beyzanur@gmailcom', 'bnur@gmail.com', '123454', '23456543', '123432', 'https://tobb.com', 'cankaya', 'Ankara', 'Turkey', 'rec', 'create', '2020-12-08'),
(11111, 'Ms', 'Beyza', 'MONGO', 'pro', 'beyzanur@gmailcom', 'bnur@gmail.com', '123454', '23456543', 'https://tobb.com', 'cankaya//uıgujh', 'cankaya', 'Ankara', 'turkey', 'rec', 'create', '2020-12-23');
...
INSERT INTO `usersinfo` (`AuthenticationID`, `Title`, `Name`, `LastName`, `Affiliation`, `primary_email`, `secondary_email`, `password`, `phone`, `fax`, `URL`, `Address`, `City`, `Country`, `Record`, `Creation`, `Date`) VALUES
(11111, 'Ms', 'elif', 'AFSAR', 'pro', 'eafsar@etu.edu.tr', 'elifnurafsr@gmail.com', 'elif1234', '444444444', '23456', 'https:/conference.com', 'koren', 'ankara', 'turkey', 'rec', 'tobb', '2020-12-04');
...
ALTER TABLE `submissions`
  ...
  ADD UNIQUE KEY `prevSubmissionID` (`prevSubmissionID`),
  ADD KEY `AuthenticationID` (`AuthenticationID`),
...
ALTER TABLE `submissions`
  ...
  ADD CONSTRAINT `submissions_ibfk_3` FOREIGN KEY (`prevSubmissionID`) REFERENCES `submissions` (`SubmissionID`) ON DELETE CASCADE ON UPDATE CASCADE;
