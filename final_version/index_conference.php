...
if (isset($_GET['edit'])) {
    //$id = $_GET['edit'];
    $update = true;
    $record = mysqli_query($db, "SELECT * FROM conference WHERE ConfID='{$_GET['edit']}'");
    if ($record) {
...
<table>
    ...
    <?php while ($row = mysqli_fetch_array($results)) { ?>
        <tr>
            ...
            <td>
                <a href="index_conference.php?edit=<?php echo $row['ConfID']; ?>" class="edit_btn" >Edit</a>
            </td>
            <td>
...
<form method="post" action="server.php" >
    ...
    <div class="input-group">
        ...
        <input type="date" name="SubmissionDeadline" value="<?php echo $SubmissionDeadline; ?>">
    </div>
    <div class="input-group">
